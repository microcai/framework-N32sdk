...
/** AFIO DIGEFT sources **/
#define AFIO_PA0_DIGEFT      (AFIO_DIGEFT_CFG1_PA0DIGEFTEN)       
#define AFIO_PA1_DIGEFT      (AFIO_DIGEFT_CFG1_PA1DIGEFTEN)    
#define AFIO_PA2_DIGEFT      (AFIO_DIGEFT_CFG1_PA2DIGEFTEN)    
#define AFIO_PA3_DIGEFT      (AFIO_DIGEFT_CFG1_PA3DIGEFTEN)     
#define AFIO_PA4_DIGEFT      (AFIO_DIGEFT_CFG1_PA4DIGEFTEN)     
#define AFIO_PA5_DIGEFT      (AFIO_DIGEFT_CFG1_PA5DIGEFTEN)     
#define AFIO_PA6_DIGEFT      (AFIO_DIGEFT_CFG1_PA6DIGEFTEN)     
#define AFIO_PA7_DIGEFT      (AFIO_DIGEFT_CFG1_PA7DIGEFTEN)     
#define AFIO_PA8_DIGEFT      (AFIO_DIGEFT_CFG1_PA8DIGEFTEN)     
#define AFIO_PA9_DIGEFT      (AFIO_DIGEFT_CFG1_PA9DIGEFTEN)       
#define AFIO_PA10_DIGEFT     (AFIO_DIGEFT_CFG1_PA10DIGEFTEN)    
#define AFIO_PA11_DIGEFT     (AFIO_DIGEFT_CFG1_PA11DIGEFTEN)    
#define AFIO_PA12_DIGEFT     (AFIO_DIGEFT_CFG1_PA12DIGEFTEN)    
#define AFIO_PA13_DIGEFT     (AFIO_DIGEFT_CFG1_PA13DIGEFTEN)    
#define AFIO_PA14_DIGEFT     (AFIO_DIGEFT_CFG1_PA14DIGEFTEN)   
#define AFIO_PA15_DIGEFT     (AFIO_DIGEFT_CFG1_PA15DIGEFTEN) 
#define AFIO_PB0_DIGEFT      (AFIO_DIGEFT_CFG1_PB0DIGEFTEN)      
#define AFIO_PB1_DIGEFT      (AFIO_DIGEFT_CFG1_PB1DIGEFTEN)    
#define AFIO_PB2_DIGEFT      (AFIO_DIGEFT_CFG1_PB2DIGEFTEN)    
#define AFIO_PB3_DIGEFT      (AFIO_DIGEFT_CFG1_PB3DIGEFTEN)    
#define AFIO_PB4_DIGEFT      (AFIO_DIGEFT_CFG1_PB4DIGEFTEN)    
#define AFIO_PB5_DIGEFT      (AFIO_DIGEFT_CFG1_PB5DIGEFTEN)     
#define AFIO_PB6_DIGEFT      (AFIO_DIGEFT_CFG1_PB6DIGEFTEN)     
#define AFIO_PB7_DIGEFT      (AFIO_DIGEFT_CFG1_PB7DIGEFTEN)    
#define AFIO_PB8_DIGEFT      (AFIO_DIGEFT_CFG1_PB8DIGEFTEN)     
#define AFIO_PB9_DIGEFT      (AFIO_DIGEFT_CFG1_PB9DIGEFTEN)    
#define AFIO_PB10_DIGEFT     (AFIO_DIGEFT_CFG1_PB10DIGEFTEN)    
#define AFIO_PB11_DIGEFT     (AFIO_DIGEFT_CFG1_PB11DIGEFTEN)   
#define AFIO_PB12_DIGEFT     (AFIO_DIGEFT_CFG1_PB12DIGEFTEN)    
#define AFIO_PB13_DIGEFT     (AFIO_DIGEFT_CFG1_PB13DIGEFTEN)   
#define AFIO_PB14_DIGEFT     (AFIO_DIGEFT_CFG1_PB14DIGEFTEN)    
#define AFIO_PB15_DIGEFT     (AFIO_DIGEFT_CFG1_PB15DIGEFTEN)  
#define AFIO_PC13_DIGEFT     (AFIO_DIGEFT_CFG2_PC13DIGEFTEN)    
#define AFIO_PC14_DIGEFT     (AFIO_DIGEFT_CFG2_PC14DIGEFTEN)    
#define AFIO_PC15_DIGEFT     (AFIO_DIGEFT_CFG2_PC15DIGEFTEN)    
#define AFIO_PD0_DIGEFT      (AFIO_DIGEFT_CFG2_PD0DIGEFTEN)     
#define AFIO_PD12_DIGEFT     (AFIO_DIGEFT_CFG2_PD12DIGEFTEN)   
#define AFIO_PD13_DIGEFT     (AFIO_DIGEFT_CFG2_PD13DIGEFTEN)    
#define AFIO_PD14_DIGEFT     (AFIO_DIGEFT_CFG2_PD14DIGEFTEN)    
#define AFIO_PD15_DIGEFT     (AFIO_DIGEFT_CFG2_PD15DIGEFTEN)  
