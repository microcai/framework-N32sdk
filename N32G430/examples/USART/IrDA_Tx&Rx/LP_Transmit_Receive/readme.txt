1、功能说明
    ...
    USARTy和USARTz可以是USART1和USART2或UART3和UART4。
...
2、使用环境
    ...
    硬件环境：最小系统板N32G430C8L7-STB V1.0、IrDA发送器及接收器
...
3、使用说明
    ...
    或
    - UART3_Tx.PB10    <------->   IrDA Transmitter
    - UART4_Rx.PB15    <------->   IrDA Receiver
    
    - GPIO.PB2         <------->   38kHz carrier
...
1. Function description
    ...
    USARTy and USARTz can be USART1 and USART2 or UART3 and UART4.
...
2. Development environment
        ...
        Hardware environment: minimum system board N32G430C8L7-STB V1.0, IrDA transmitter and receiver
