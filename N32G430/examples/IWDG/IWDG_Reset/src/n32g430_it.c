...
{
    if (TIM_Interrupt_Status_Get(TIM2, TIM_INT_CC3) != RESET)
    {
        if (CaptureNumber == 0)
        {
            /* Get the Input Capture value */
            IC1ReadValue1 = TIM_Compare_Capture3_Get(TIM2);
        }
        else if (CaptureNumber == 2)
        {
            RCC_ClocksType clks;
            /* Get the Input Capture value */
            IC1ReadValue2 = TIM_Compare_Capture3_Get(TIM2);
            ...
            RCC_Clocks_Frequencies_Value_Get(&clks);
        ...
        TIM_Interrupt_Status_Clear(TIM2, TIM_INT_CC3);
    }
}
