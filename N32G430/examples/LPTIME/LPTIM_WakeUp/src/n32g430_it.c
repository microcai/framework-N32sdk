...
/**
*\*\name   LPTIM_WKUP_IRQHandler.
*\*\fun    This function handles LPTIM interrupt request.
*\*\param  none
*\*\return none 
*\*\none   Useing LPTIM interrupt must enable EXIT line 20
**/
void LPTIM_WKUP_IRQHandler(void)
{
    if (LPTIM_Flag_Get(LPTIM, LPTIM_INTSTS_FLAG_CMPM) != RESET)
    {
        LPTIM_FLAG_Clear(LPTIM, LPTIM_CLEAR_FLAG_CMPM);
