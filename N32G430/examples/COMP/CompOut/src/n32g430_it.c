...
/**
*\*\name    PPP_IRQHandler.
*\*\fun     This function handles COMP1_2_3 Handler.
*\*\note  When the INP voltage is higher than the INM voltage, the interrupt will always be triggered; 
*\*\      if you want to not trigger, you should turn off the interrupt directly
*\*\return  none
**/
void COMP_1_2_3_IRQHandler(void)
{
    if(COMP_Interrupt_Status_OneComp_Get(COMP1) 
       | EXTI_Interrupt_Status_Get(EXTI_LINE21))
    {
