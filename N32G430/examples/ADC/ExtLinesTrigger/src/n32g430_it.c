...
extern __IO uint16_t ADC_InjectedConvertedValueTab[10];
uint32_t Index = 0;
...
void ADC_IRQHandler(void)
{
    ...
    /* Get injected channel12 and channel13 converted value */
    ADC_InjectedConvertedValueTab[Index++] = ADC_Injected_Group_Conversion_Data_Get(ADC_INJECTED_DATA_REG_1);
    ADC_InjectedConvertedValueTab[Index++] = ADC_Injected_Group_Conversion_Data_Get(ADC_INJECTED_DATA_REG_2);
